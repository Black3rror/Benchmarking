...
typedef ek_model_handle_t ModelHandler;
#elif MODEL_TYPE == INCREMENTAL
typedef ek_inc_model_handle_t ModelHandler;
#endif
...
typedef ek_value_t ModelInput[INPUT_SIZE];
...
typedef ek_value_t ModelOutput[1];
